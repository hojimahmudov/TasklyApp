...
class House(models.Model):
    ...
    image = models.FileField(upload_to=house_image_path, blank=True, null=False)
    created_on = models.DateTimeField(auto_now_add=True)
    description = models.TextField()
    manager = models.OneToOneField('users.Profile', on_delete=models.SET_NULL, blank=True, null=True,
